  ...
  return (
    <div className="h-screen flex items-center justify-center bg-zinc-900 text-white">
      <form
        ...
        className="bg-zinc-800 p-8 rounded-lg shadow-lg w-96 flex flex-col gap-4"
      >
        ...
        <button
          type="submit"
          className="bg-green-600 p-2 rounded font-bold hover:bg-green-500 transition-colors mt-4"
        >
          ENTRAR
        </button>
      </form>
